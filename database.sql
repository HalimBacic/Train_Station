...
-- -----------------------------------------------------
-- procedure ispisLinije
-- -----------------------------------------------------

USE `czsmdp`;
DROP procedure IF EXISTS `czsmdp`.`ispisLinije`;

DELIMITER $$
USE `czsmdp`$$
CREATE PROCEDURE `ispisLinije` (IN i INT)
BEGIN
select * from `stanka` as s
inner join `linija` as l
on `l`.i = `s`.i;
END$$
